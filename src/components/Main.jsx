...
export default function Main() {
  ...
  function addIngredient(e) {
    ...
    console.log(newIngredient); // Now this should log correctly
  ...
  return (
    <main>
      ...
      {/* Conditionally render the section when there are ingredients */}
      {ingredients.length > 0 && (
                         < ClaudeRecipe ingredientsListItems = {ingredientsListItems}  ingredients = {ingredients} toggle = {toggleRecipeShown}  />
